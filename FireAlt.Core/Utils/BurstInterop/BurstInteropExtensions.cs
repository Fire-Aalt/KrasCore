...
namespace FireAlt.Core.Utility
{
    ...
    {
        public static void Invoke(this BurstInterop wrapper)
        {
            var arguments = default(BurstManagedNoArgs);
            wrapper.Invoke(ref arguments);
        }

        public static void Invoke<T>(this BurstInterop wrapper, in T value)
            where T : unmanaged
        {
            var arguments = value;
            wrapper.Invoke(ref arguments);
        ...
        public static void Invoke<TFirst, TSecond>(this BurstInterop wrapper, in TFirst first, in TSecond second)
            where TFirst : unmanaged
            where TSecond : unmanaged
        {
        ...
        public static void Invoke<TFirst, TSecond, TThird>(this BurstInterop wrapper, in TFirst first, in TSecond second, in TThird third)
            where TFirst : unmanaged
            where TSecond : unmanaged
            where TThird : unmanaged
        {
        ...
        public static void InvokeOut<TIn, TOut>(this BurstInterop wrapper, in TIn input, out TOut value)
            where TIn : unmanaged
            where TOut : unmanaged
        {
        ...
        public static void InvokeOut<TFirst, TSecond, TOut>(this BurstInterop wrapper, in TFirst first, in TSecond second, out TOut value)
            where TFirst : unmanaged
            where TSecond : unmanaged
            where TOut : unmanaged
        {
